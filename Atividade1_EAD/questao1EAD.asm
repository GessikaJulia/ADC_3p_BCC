...
li $t5, 4 #Carrega o valor 4 no registrador $t5 para usar como divisor.
div $t4, $t5 #Divide o valor em $t4 pelo valor em $t5. O resultado é armazenado em $LO.
mflo $t4 #Move o valor do registrador $LO para $t4. $LO contém o quociente da última divisão.
